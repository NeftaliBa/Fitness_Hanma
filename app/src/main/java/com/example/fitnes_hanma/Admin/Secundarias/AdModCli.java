...
import com.example.fitnes_hanma.Admin.Principal.SeeViews;
import com.example.fitnes_hanma.R;

public class AdModCli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad_mod_cli);
        ...
        cancelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                i = new Intent(AdModCli.this, AdCliente.class);
                startActivity(i);
            }
        });
